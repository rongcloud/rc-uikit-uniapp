<template>
<view class="rc-face-box">
  <view class="rc-face-list">
    <view class="rc-face-item" v-for="(face, index) in defaultFaces" :key="index" @click.stop.prevent="onClickFace(face)">
      {{ face }}
    </view>
  </view>
</view>
